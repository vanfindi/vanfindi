...
function newkeyChoice(toolChoice) { //toolchoice is the key that was pressed
 ...
 if (toolChoice == '1' ) {  // hair
    ...
    image(hair, mouseX-125, mouseY-50, 250, 250);
    
  } else if (toolChoice == '2') { // fur

    image(fur, mouseX-125, mouseY-50, 250, 250);
    
  } else if (toolChoice == '3') { // stray hairs

    image(strays, mouseX-125, mouseY-50, 250, 250);
   ...
   image(tag, mouseX-125, mouseY-50, 250, 250);
    
 // make testbox do something!
 //   line(mouseX, mouseY, pmouseX, pmouseY);
  } else if (toolChoice == '6') { // eyes
 
   image(eyes, mouseX-125, mouseY-50, 320, 250)
    ...
    line(mouseX, mouseY, pmouseX, pmouseY);
     ...
     image(yarn, mouseX-125, mouseY-50, 320, 250)
