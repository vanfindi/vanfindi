...
function preload() {
  base = loadImage('https://vanfindi.github.io/game/curtain.jpg');
...
background(base);   // background screen color
...
// p calls the routine saveme, which saves a copy of the screen
  if (key == 'x' || key == 'X') {
    background(base); // set the screen back to the background color
  } else if (key == 'p' || key == 'P') {
